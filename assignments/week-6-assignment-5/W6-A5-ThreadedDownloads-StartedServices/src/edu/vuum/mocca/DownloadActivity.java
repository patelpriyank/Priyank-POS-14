...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (activity != null) {
            	...
            	String downloadedImageUrl = msgData.getString(DownloadUtils.PATHNAME_KEY);

				if(downloadedImageUrl != null){
					activity.displayBitmap(downloadedImageUrl);
				}
            }
    	}
    }
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	String imgUrl = getUrlString();
        	Intent downloadIntentServiceIntent = DownloadIntentService.makeIntent(this, handler, imgUrl);
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	String imgUrl1 = getUrlString();
        	Intent threadPoolIntent = ThreadPoolDownloadService.makeIntent(this, handler, imgUrl1);
